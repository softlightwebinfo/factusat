...
class Paginator
{
    ...
    protected function generarLimit()
    {
    ...
    public function toHtml()
    {
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li><a class="Pagination__item--prev" href="' . $this->getPrevUrl() . '">&laquo; ' . $this->previousText . '</a></li>';
        }
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li><a ' . ($page['isCurrent'] ? ' class="Pagination__item--active"' : 'class="Pagination__item"') . ' href="' . $page['url'] . '">' . $page['num'] . '</a></li>';
            } else {
                $html .= '<li class="disabled Pagination__item--disabled"><span>' . $page['num'] . '</span></li>';
            }
        }
        if ($this->getNextUrl()) {
            $html .= '<li><a class="Pagination__item--next" href="' . $this->getNextUrl() . '">' . $this->nextText . ' &raquo;</a></li>';
        }
        $html .= '</ul>';
        return $html;
    }
